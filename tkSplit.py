...
#        self.message("Out: " + self.nameOut.get())
        ...
        try:
            split.split(self.nameIn.get(), choice=self.choice.get(),
...
##        Label(frame, text='Format:').grid(row=0, column=0, sticky=W)
        Radiobutton(frame, variable=self.choice, value='ENVI', text='ENVI').grid(row=0, column=0, sticky=W)
        Radiobutton(frame, variable=self.choice, value='JPEG', text='JPEG').grid(row=0, column=1, sticky=W)
        Radiobutton(frame, variable=self.choice, value='TIFF', text='TIFF').grid(row=0, column=2, sticky=W)
        Radiobutton(frame, variable=self.choice, value='PNG', text='PNG').grid(row=0, column=3, sticky=W)
        self.choice.set(conf.get_option('output-format', "JPEG"))
...
conf.set_option('output-format', app.choice.get())
