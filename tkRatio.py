...
class Application(Frame):
    ...
    def do_run(self) :
        ...
        try:
            ratio.ratio(self.nameIn.get(), self.nameOut.get(),
                    self.band1.get(),
                    self.band2.get(),
...
#            if self.nameOut.get() == "":
    ...
    def makeWindow(self):
        # variables
        self.band1 = DoubleVar()
        self.band1.set(conf.get_option('band1', 1900.0, type_=float))
        self.band2 = DoubleVar()
        self.band2.set(conf.get_option('band2', 2200.0, type_=float))
        ...
        Label(frame, text="Ratio = ").grid(row=0, column=0, sticky=W)
        Entry(frame, width=8, textvariable=self.band1).grid(row=0, column=1, sticky=W)
        Label(frame, text="/").grid(row=0, column=2, sticky=W)
        Entry(frame, width=8, textvariable=self.band2).grid(row=0, column=3, sticky=W)
