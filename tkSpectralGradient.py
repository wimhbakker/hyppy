#!/usr/bin/python3
#
#     tkSpectralGradient.py
##  Created 20200901 WHB 
##
...
class Application(Frame):
    ...
    def do_run(self) :
        ...
        try:
            spectralgradient.spectralgradient(self.nameIn.get(), self.nameOut.get(),
