...
class Application(Frame):
    ...
    def do_run(self) :
        ...
        try:
            ratios.ratios(self.nameIn.get(), self.nameOut.get(), delta=self.delta.get(),
...
#            if self.nameOut.get() == "":
    ...
    def makeWindow(self):
        # variables
        self.delta = IntVar()
        self.delta.set(conf.get_option('delta', 1, type_=int))
