...
DESCRIPTION = "Geometric Correction"
...
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.message("Using Lat/Lon file")
...
#        self.logFile = self.nameOut.get() + LOGEXT
        ...
        try:
            geo_correction.latlon_geo_correction(self.nameIn.get(),
                      self.nameOut.get(),
...
#            if self.nameOut.get() == "":
    ...
    def pick_geocube_spectrum(self):
        self.message("Pick Lat/Lon file.")
        self.message("May end with '_lonlat'")
##        name = self.nameIn.get()
##        if name:
##            idir = os.path.dirname(name)
##        else:
##            idir = r'D:'
    ...
    def makeWindow(self):
        ...
        # input geocube file
        Label(self, text="LatLon").grid(row=row, column=0, sticky=W)
