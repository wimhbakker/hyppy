...
DESCRIPTION = "Resample with step"
...
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.makeWindow()
        self.message("Resample image with step size")
    ...
    def do_run(self) :
        ...
        try:
            resample.resample(self.nameIn.get(), self.nameOut.get(),
...
##            self.nameOffset.set(name)
    ...
    def makeWindow(self):
        ...
        self.stepSize.set(conf.get_option('step-size', 2, type_=int))
        ...
        Label(frame, text="Step size: ").grid(row=0, column=0, sticky=W)
        Entry(frame, textvariable=self.stepSize, width=5).grid(row=0, column=1, sticky=W)
...
conf.set_option('step-size', app.stepSize.get())
