...
DESCRIPTION = "Minimum Wavelength v2"
...
class Application(Frame):
    ...
    def do_run(self) :
        ...
        if 0<n<4:
            ...
            try:
                minwavelength2.minwavelength(self.nameIn.get(), self.nameOut.get(),
                                        ...
                                        broad=self.broad.get(),
                                        numfeatures=self.numFeatures.get())
    ...
    def makeWindow(self):
        ...
        self.numFeatures = IntVar()
        self.numFeatures.set(conf.get_option('num_features', 1, type_=int))
...
conf.set_option('num_features', app.numFeatures.get())
