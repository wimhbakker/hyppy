...
DESCRIPTION = "Convert ASTER HDF file"
...
class Application(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.message("""
This program uses the GDAL scripts.
""")
    ...
    def do_run(self) :
        ...
        try:
            convaster.convert_aster(self.nameIn.get(),
    ...
    def pick_input(self):
        ...
        if name:
            ...
            # set output basename to file name without extension
            self.nameOut.set(os.path.splitext(name)[0])
        
    def pick_output(self):
        self.message("Pick output basename.")
        odir = conf.get_option('output-dir')
        name = asksaveasfilename(title='Pick Output Basename',
                                   initialdir=odir,
                                   initialfile='')
        if name:
