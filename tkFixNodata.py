...
""")
    ...
    def do_run(self) :
        ...
        try:
            fixnodata.fixnodata(self.nameIn.get(), self.nameOut.get(),
...
#            if self.nameOut.get() == "":
    ...
    def makeWindow(self):
        ...
        Entry(self, width=30, textvariable=self.nodata).grid(row=row, column=1, sticky=W)
        Label(self, text="Nodata").grid(row=row, column=0, sticky=W)
